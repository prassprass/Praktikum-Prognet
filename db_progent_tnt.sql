...
MySQL - 5.5.5-10.1.28-MariaDB : Database - db_progent_tnt
*********************************************************************
*/
...
insert  into `tbl_admin`(`id_admin`,`username`,`password`) values (1,'admin','admin');
...
insert  into `tbl_booking`(`id_booking`,`id_user`,`banyak_traveler`,`tgl_booking`,`id_paket`,`tgl_traveling`,`permintaan_spesial`,`biaya_traveling`,`biaya_tambahan`,`ket_biaya_tambahan`,`status_pembayaran`,`status_cancle`) values (27,1,2,'2018-05-07',7,'2018-05-24','',2400000,0,'Tidak ada Tambahan Bosss, Siap berangkat',1,0),(28,2,1,'2018-05-08',2,'2019-03-15','',780000,NULL,NULL,0,1),(29,1,15,'2018-05-09',2,'2018-05-17','',11700000,NULL,NULL,0,1),(30,4,2,'2018-05-16',9,'2018-05-28','spesial',4400000,10000,'Biaya Parkir UFO',0,0),(32,1,1,'2018-05-17',1,'2018-05-31','jemput di Bandara jam 2 pagi',3400000,NULL,NULL,1,0),(33,1,2,'2018-05-17',1,'2018-07-27','',6800000,NULL,NULL,-1,0),(34,1,2,'2018-05-17',8,'2019-03-21','',18200000,NULL,NULL,0,0);
...
insert  into `tbl_det_paket_hotel`(`id_det_hotel`,`id_paket`,`id_hotel`,`banyak_malam_hotel`) values (17,7,5,2),(24,8,5,2),(31,9,5,3),(38,9,22,1),(40,1,22,2),(41,2,30,1),(42,10,17,0),(43,11,7,0);
...
insert  into `tbl_det_paket_wisata`(`id_det_wisata`,`id_paket`,`id_wisata`) values (11,8,2),(12,8,12),(16,2,15),(23,9,2),(24,8,15),(27,9,15),(30,9,16),(31,1,12),(32,2,17),(33,7,2),(34,10,17),(35,11,18);
...
insert  into `tbl_hotel`(`id_hotel`,`nama_hotel`,`alamat_hotel`,`tlpn_hotel`,`biaya_permalam`,`status_aktif`) values (5,'Nyuh Bengkok Tree House','Sental kangin, Desa Ped, Kec. Nusa Penida','089516644259',250000,1),(6,'Hotel Tjamphuhan','Jl. Raya Campuan, Sayan, Ubud, Kabupaten Gianyar, Bali 80571','(0361) 97536',1400000,1),(7,'Ayana Resort','Jalan raya Seminyak no.109B','(0361)215698',2500000,1),(17,'The Somayan Bungalows','Desa Batu Lapan, Suana, Nusapenida, Kabupaten Klungkung, Bali ','0813532212',412000,1),(22,'Bali Paragon Resort','Jl. Raya Kampus Unud, Jimbaran, Bali, Kabupaten Badung, Bali 80361','(0361) 47252',641000,1),(23,'33','33','33',2220000,0),(28,'test','test','test',111,0),(29,'33','33','333',333,0),(30,'The Cave Hotel','Batur Tengah, Kintamani, Kabupaten Bangli, Bali 80652','081337787816',800000,1);
...
insert  into `tbl_jenis_wisata`(`id_jenis_wisata`,`jenis_wisata`) values (1,'Water Sport'),(2,'Kebun Raya'),(3,'Air Terjun'),(4,'Pantai'),(5,'Hiking'),(6,'Wisata Laut'),(7,'aa');
...
insert  into `tbl_moment`(`id_moment`,`judul_moment`,`lokasi_moment`,`tanggal_moment`,`deskripsi_moment`,`foto_moment`) values (1,'Kecerian','Bali, indonesia','2018-04-24','Serunya hari ini','selfie.jpg'),(2,'Long Night','Kubutambahan, Singaraja, Bali','2017-10-03','So live a life u will remember ','IMG_3850.jpg'),(3,'Istirahat perjalanan','Pasar Baturiti, Tabanan','2018-04-25','bermain tik tak tu, minum coklat panas, bermain permain pazel, menghitung bintang bermain tik tak tu, minum coklat panas, bermain permain pazel, menghitung bintang bermain tik tak tu, minum coklat pan','IMG_3860.JPG');
...
insert  into `tbl_paket`(`id_paket`,`nama_paket`,`banyak_hari`,`banyak_malam`,`harga_paket`,`deskripsi_paket`,`foto_paket`,`status_aktif_paket`) values (1,'Paket Lama Dijalan',3,2,1998000,'Paket lama dijalan merupakan paket yang diperuntukan untuk wisatawan yang suka menikmati perjalanan, oleh karena itu kami siapan paket wisata dimana objek wisatanya sangat jauh dari hotel.','Tulips.jpg',1),(2,'Paket Bangli Nikmat',2,1,1342500,'Wisatawan dapat menimati indahnya kabupaten Bangli dimana wisatawan dapat mendaki Gunung Batur dan berendam di pemandian air panas','Tulips2.jpg',1),(7,'Paket Kusuka Nusa',3,2,795000,'Paket Kusuka Nusa merupakan paket wisata di pulau Nusa Penida dimana wisatawan dapat menikmati keindahan Pantai di Nusa Penisa dan bermalam di Nusa Penida juga','Tulips1.jpg',1),(8,'d',4,2,900000,'d','Desert.jpg',0),(9,'e',5,4,2236500,'e','Koala.jpg',0),(10,'Paket Hangat Hangat',1,2,112500,'Paket ini merupakan paket wisata menginap di salah satu hotel di Bangli dan mandi di pemandian air pana Toya Devasya dan menikmati pemandangan Gunung Batur','kolam-air-panas-toya-devasya-kintamani-bali.jpg',1),(11,'Paket Buang Uang',1,1,12000,'Paket Buang Uang merupakan paket yang dikhususkan kepada para Sultan yang ingin menghabiskan uang di Bali dengan berbelanja di Mall Bali Galeria','Mall-Bali-Galeria1.jpg',1);
...
insert  into `tbl_pembayaran`(`id_pembayaran`,`id_booking`,`atas_nama_pengirim`,`bukti_transaksi`,`tgl_upload_bukti`,`status_valid`) values (20,27,'I PUTU KRISNA ARYNASTA','ijasah.jpg','2018-05-08',1),(22,32,'IGA Made Gates Syn','timeline_20170705_193650.jpg','2018-05-17',1),(23,34,'I PUTU KRISNA ARYNASTA','bvn.jpg','2018-05-17',0);
...
insert  into `tbl_user`(`id_user`,`email`,`password`,`nama_user`,`no_indentitas`,`tlpn_user`,`alamat_user`) values (1,'krisnaarinasta@gmail.com','123','Krisna Arynasta','1142588935481','089999999999','Bali'),(2,'a@a','123','Mader Paker',NULL,NULL,NULL),(3,'jon@gmail.com','123','Jon Tor','289465482','0284851','St. James 122, SIngapore'),(4,'Devajayantha@gmail.com','deva110398','devajayantha','000000000000','000000000000','jalan jalan'),(5,'b@b','123','BnB','91118979871117','89682891','B aja');
